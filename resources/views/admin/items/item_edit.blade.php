          ...
          <div class="card card-outline card-info">
              ...
              <div class="card-body pad">
                  ...
                  <form id="editForm-{{ $item->id }}">
                    <div class="col-md-12">
                      <div class="row ">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 pl-0 form-group">
                          <label>Тизер</label>
                          <input type="text" name="teaser_ru" value="{{ $item->teaser_ru }}" class="form-control" placeholder="Тизер">
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-4 pl-0 form-group">
                ...
                <p class="text-sm mb-0">
                  ...
                  <button class="save-button action-buttons mt-2" onclick="editItem('insert',{{ $item->id }},'editForm-{{ $item->id }}')">
                    Сохранить изменения
                  </button>
                </p>
              </div>
