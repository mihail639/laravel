                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-12 col-md-4">
                      <div id="example1_filter" class="text-center">
                        <button class="add-button action-buttons" onclick="addItem('form','','','category','/{{ $section }}');">Добавить запись</button>
                      </div>
                      <div id="example1_filter" class="text-center">
                        <button id="delete-all-button" class="delete-all-button action-buttons" onclick="deleteChecked('category','/{{ $section }}');" style="display:none;">Удалить отмеченные</button>
                      </div>
                    </div>
                    <div class="col-sm-12 col-md-4">
