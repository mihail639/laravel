          ...
          <div class="card card-outline card-info">
              ...
              <div class="card-body pad">
                    ...
                    <div class="col-md-12">
                      <div class="row ">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 pl-0 form-group">
                          ...
                          <input type="text" name="parent_id" value="0" class="form-control" placeholder="Parent ID">
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-4 pl-0 form-group">
                ...
                <p class="text-sm mb-0">
                  ...
                  <button class="save-button action-buttons mt-2" onclick="addItem('insert','','addForm','category','/{{ $section }}')">
                    Сохранить изменения
                  </button>
                </p>
              </div>
